...
import { fayahoo, favine, fatelegram ,  favimeosquare, fatwitter, faskype, fapaypal, faredditalien, falinux, faquora, fachrome,  fagithubalt } from '@fontawesome/free-regular-svg-icons'
import GamePiece from './components/GamePiece';
import Nav from './components/Nav/Nav';

class App extends Component {
    state = {
        icons: [fayahoo, favine, fatelegram ,  favimeosquare, fatwitter, faskype, fapaypal, faredditalien, falinux, faquora, fachrome,  fagithubalt].sort(this.randomize),
        clicked: [],
        score: 0,
        highScore: 0,
        correct: undefined,
